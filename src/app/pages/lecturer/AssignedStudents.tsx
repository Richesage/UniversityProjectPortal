...
export function AssignedStudents() {
  const { lecturerStudents } = useAppData();
        ...
        <table className="w-full text-left text-sm min-w-[720px]">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-4 py-3 font-medium text-gray-700">Last Submission</th>
          ...
          <tbody className="divide-y divide-gray-200">
            {filtered.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-4 text-gray-600">{item.regNo}</td>
                <td className="px-4 py-4 text-gray-700 truncate max-w-[150px]">{item.topic}</td>
                ...
                <td className="px-4 py-4 text-gray-600">{item.lastSubmission}</td>
                <td className="px-4 py-4">
        ...
        <DialogContent>
          ...
          {selectedStudent && dialogMode === 'meeting' && (
            <div className="space-y-4">
              ...
              <input type="date" className="w-full border border-gray-300 rounded-md py-2 px-3 text-sm" />
              <input type="time" className="w-full border border-gray-300 rounded-md py-2 px-3 text-sm" />
